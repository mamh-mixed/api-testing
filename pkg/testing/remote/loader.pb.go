...
var file_pkg_testing_remote_loader_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xbf, 0x0d, 0x0a, 0x06, 0x4c, 0x6f, 0x61, 0x64,
	...
	0x00, 0x12, 0x2f, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x6e, 0x75, 0x73, 0x12, 0x0d, 0x2e,
	...
	0x22, 0x00, 0x12, 0x35, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x50, 0x61, 0x67, 0x65, 0x12, 0x12, 0x2e,
	...
	0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x32, 0x96, 0x02, 0x0a, 0x0d, 0x53, 0x65,
...
var file_pkg_testing_remote_loader_proto_depIdxs = []int32{
	...
	16, // 35: remote.Loader.GetPage:input_type -> server.SimpleName
	17, // 36: remote.SecretService.GetSecret:input_type -> server.Secret
	10, // 37: remote.SecretService.GetSecrets:input_type -> server.Empty
	17, // 38: remote.SecretService.CreateSecret:input_type -> server.Secret
	17, // 39: remote.SecretService.DeleteSecret:input_type -> server.Secret
	17, // 40: remote.SecretService.UpdateSecret:input_type -> server.Secret
	10, // 41: remote.ConfigService.GetConfigs:input_type -> server.Empty
	16, // 42: remote.ConfigService.GetConfig:input_type -> server.SimpleName
	5,  // 43: remote.ConfigService.CreateConfig:input_type -> remote.Config
	5,  // 44: remote.ConfigService.UpdateConfig:input_type -> remote.Config
	16, // 45: remote.ConfigService.DeleteConfig:input_type -> server.SimpleName
	0,  // 46: remote.Loader.ListTestSuite:output_type -> remote.TestSuites
	10, // 47: remote.Loader.CreateTestSuite:output_type -> server.Empty
	1,  // 48: remote.Loader.GetTestSuite:output_type -> remote.TestSuite
	1,  // 49: remote.Loader.UpdateTestSuite:output_type -> remote.TestSuite
	10, // 50: remote.Loader.DeleteTestSuite:output_type -> server.Empty
	18, // 51: remote.Loader.RenameTestSuite:output_type -> server.HelloReply
	19, // 52: remote.Loader.ListTestCases:output_type -> server.TestCases
	10, // 53: remote.Loader.CreateTestCase:output_type -> server.Empty
	8,  // 54: remote.Loader.GetTestCase:output_type -> server.TestCase
	8,  // 55: remote.Loader.UpdateTestCase:output_type -> server.TestCase
	10, // 56: remote.Loader.DeleteTestCase:output_type -> server.Empty
	18, // 57: remote.Loader.RenameTestCase:output_type -> server.HelloReply
	2,  // 58: remote.Loader.ListHistoryTestSuite:output_type -> remote.HistoryTestSuites
	10, // 59: remote.Loader.CreateTestCaseHistory:output_type -> server.Empty
	13, // 60: remote.Loader.GetHistoryTestCaseWithResult:output_type -> server.HistoryTestResult
	9,  // 61: remote.Loader.GetHistoryTestCase:output_type -> server.HistoryTestCase
	10, // 62: remote.Loader.DeleteHistoryTestCase:output_type -> server.Empty
	10, // 63: remote.Loader.DeleteAllHistoryTestCase:output_type -> server.Empty
	20, // 64: remote.Loader.GetTestCaseAllHistory:output_type -> server.HistoryTestCases
	21, // 65: remote.Loader.GetVersion:output_type -> server.Version
	22, // 66: remote.Loader.Verify:output_type -> server.ExtensionStatus
	23, // 67: remote.Loader.PProf:output_type -> server.PProfData
	24, // 68: remote.Loader.Query:output_type -> server.DataQueryResult
	25, // 69: remote.Loader.GetThemes:output_type -> server.SimpleList
	26, // 70: remote.Loader.GetTheme:output_type -> server.CommonResult
	25, // 71: remote.Loader.GetBindings:output_type -> server.SimpleList
	26, // 72: remote.Loader.GetBinding:output_type -> server.CommonResult
	25, // 73: remote.Loader.GetMenus:output_type -> server.SimpleList
	26, // 74: remote.Loader.GetPage:output_type -> server.CommonResult
	17, // 75: remote.SecretService.GetSecret:output_type -> server.Secret
	27, // 76: remote.SecretService.GetSecrets:output_type -> server.Secrets
	26, // 77: remote.SecretService.CreateSecret:output_type -> server.CommonResult
	26, // 78: remote.SecretService.DeleteSecret:output_type -> server.CommonResult
	26, // 79: remote.SecretService.UpdateSecret:output_type -> server.CommonResult
	4,  // 80: remote.ConfigService.GetConfigs:output_type -> remote.Configs
	5,  // 81: remote.ConfigService.GetConfig:output_type -> remote.Config
	26, // 82: remote.ConfigService.CreateConfig:output_type -> server.CommonResult
	26, // 83: remote.ConfigService.UpdateConfig:output_type -> server.CommonResult
	26, // 84: remote.ConfigService.DeleteConfig:output_type -> server.CommonResult
